      ...
      <div className="max-w-5xl mx-auto p-6 text-justify text-gray-600">
        ...
        <div className="bg-white rounded-lg  p-6 mb-6">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-2/3 md:pl-6">
              ...
              <p className="mb-4">
                Narendra Singh Bhondekar is a prominent politician and dedicated
                public servant from Bhandara-Gondia. Born on June 20, 1974 in
                Bhandara, he has risen to become a significant figure in
                Maharashtra's political landscape. Known for his unwavering
              ...
              <p>
                Bhondekar's childhood was born into a family with a farming
                ...
                endeavors in politics and governance.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg  p-6 mb-6">
          ...
          <p>
            ...
            election as an independent candidate from the Bhandara constituency.
            His victory marked the beginning of his formal political career,
            driven by his passion to bring about significant developmental
            changes in the region.
          </p>

          <h2 className="font-semibold text-black mt-4 mb-2">
          ...
          <p>
            ...
            villages, and improving water supply systems. He initiated several
          ...
          <p>
            Bhondekar was re-elected in 2019, reaffirming the continued trust
            and support of the people of Bhandara. His second term saw an
            intensification of his development agenda, particularly in the areas
            of rural development, agricultural support, and employment
            generation.
          </p>
          ...
          <p>
            ...
            development centers, enhancing healthcare facilities, and promoting
        ...
        <div className="bg-white rounded-lg  p-6 mb-6">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <img
              ...
              className="md:w-1/3 rounded-lg mb-4 md:mb-0 md:mr-4"
            />
            <p className="md:w-2/3">
              Narendra Bhondekar's political journey began with his election to
              the Maharashtra Legislative Assembly representing the
              Bhandara-Gondia Sakoli constituency. His tenure was marked by a
              focus on grassroots development, addressing local issues, and
              implementing policies that benefited his constituents. Recognizing
              his dedication and effectiveness, the people of Bhandara
              re-elected him in 2019, reaffirming their faith in his leadership.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 mb-6">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center">
            <img
              src={commitment}
              alt="Public service"
              className="md:w-1/3 rounded-lg mb-4 md:mb-0 md:ml-4"
            />
            <p className="md:w-2/3">
              ...
              including infrastructure development, healthcare reforms, and
              education support. His campaign to promote sustainable farming
              practices and support rural farmers has been particularly
              impactful.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-6">
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            />
            <p className="md:w-2/3">
              Narendra Bhondekar's legacy is one of dedication, hard work, and
              an unwavering commitment to the betterment of his community. His
              efforts have brought significant positive changes to Bhandara,
              improving the lives of its residents and setting a benchmark for
              other politicians. As he continues to serve his constituency, his
              impact is felt not only in Bhandara but across Maharashtra,
